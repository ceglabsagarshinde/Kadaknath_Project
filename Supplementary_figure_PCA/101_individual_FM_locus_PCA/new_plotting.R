tiff("new_flank1_pca101.tiff", width = 10, height = 9, units = 'in', res = 200)
C <- read.table(file="genolike_101_flank1.beagle.gz.cov.cov")
m<-as.matrix(C)
e <- eigen(m, symm=TRUE)
...
tiff("new_dup1_pca101.tiff", width = 10, height = 9, units = 'in', res = 200)
C <- read.table(file="genolike_101_dup1.beagle.gz.cov.cov")
m<-as.matrix(C)
e <- eigen(m, symm=TRUE)
e$val <- e$val/sum(e$val)
cat(signif(e$val, digits=3)*100,"\n")
...
tiff("new_int_pca101.tiff", width = 10, height = 9, units = 'in', res = 200)
C <- read.table(file="genolike_101_int.beagle.gz.cov.cov")
m<-as.matrix(C)
e <- eigen(m, symm=TRUE)
e$val <- e$val/sum(e$val)
cat(signif(e$val, digits=3)*100,"\n")
...
tiff("new_dup2_pca101.tiff", width = 10, height = 9, units = 'in', res = 200)
C <- read.table(file="genolike_101_dup2.beagle.gz.cov.cov")
m<-as.matrix(C)
e <- eigen(m, symm=TRUE)
e$val <- e$val/sum(e$val)
cat(signif(e$val, digits=3)*100,"\n")
...
tiff("new_flank2_pca101.tiff", width = 10, height = 9, units = 'in', res = 200)
C <- read.table(file="genolike_101_flank2.beagle.gz.cov.cov")
m<-as.matrix(C)
e <- eigen(m, symm=TRUE)
e$val <- e$val/sum(e$val)
cat(signif(e$val, digits=3)*100,"\n")
