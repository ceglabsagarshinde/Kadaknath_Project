tiff("all_black_pca_Int.tiff", width = 10, height = 9, units = 'in', res = 200)
...
tiff("all_black_pca_dup1.tiff", width = 10, height = 9, units = 'in', res = 200)
...
#text(e$vectors[,1],e$vectors[,2],pop1$pop)
box(lwd=3)
legend("bottomleft",legend=c("Ayam Cemani", "Emei BBC", "Jiuyuan BBC", "Kadaknath", "Miyi BBC", "Muchuan BBC", "Silkie", "Tianfu BBC", "Tibetan BBC", "Xichuan BBC", "Yeonsan Ogye"),col=c("black","black","black","black","black","black","black","black","black","black","black","black","black","black","black","black","black"),pch=c(12, 4, 5, 1, 7, 6, 13, 8, 2, 3, 10),cex=1.3,lwd=2,lty=c(NA), bty="n")
dev.off()


tiff("all_black_pca_dup2.tiff", width = 10, height = 9, units = 'in', res = 200)
...
tiff("all_black_pca_flank1.tiff", width = 10, height = 9, units = 'in', res = 200)
...
tiff("all_black_pca_flank2.tiff", width = 10, height = 9, units = 'in', res = 200)
