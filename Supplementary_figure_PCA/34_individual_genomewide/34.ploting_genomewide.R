tiff("pca34_PC1_PC2.tiff", width = 10, height = 9, units = 'in', res = 200)
...
tiff("pca34_PC1_PC3.tiff", width = 10, height = 9, units = 'in', res = 200)
C <- read.table(file="genolike_34.cov.cov")
m<-as.matrix(C)
e <- eigen(m, symm=TRUE)
e$val <- e$val/sum(e$val)
...
tiff("pca34_PC2_PC3.tiff", width = 10, height = 9, units = 'in', res = 200)
C <- read.table(file="genolike_34.cov.cov")
m<-as.matrix(C)
e <- eigen(m, symm=TRUE)
e$val <- e$val/sum(e$val)
