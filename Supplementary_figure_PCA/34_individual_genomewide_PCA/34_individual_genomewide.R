tiff("all_black_pc1_pc2_new_labels.tiff", width = 10, height = 9, units = 'in', res = 200)
...
tiff("all_black_pc1_pc3_new_labels.tiff", width = 10, height = 9, units = 'in', res = 200)
C <- read.table(file="genolike_34.cov.cov")
m<-as.matrix(C)
e <- eigen(m, symm=TRUE)
e$val <- e$val/sum(e$val)
...
tiff("all_black_pc2_pc3_new_labels.tiff", width = 10, height = 9, units = 'in', res = 200)
C <- read.table(file="genolike_34.cov.cov")
m<-as.matrix(C)
e <- eigen(m, symm=TRUE)
e$val <- e$val/sum(e$val)
