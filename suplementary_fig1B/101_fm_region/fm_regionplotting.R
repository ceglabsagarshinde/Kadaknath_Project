tiff("flank1_pca101.tiff", width = 10, height = 9, units = 'in', res = 200)
...
tiff("dup1_pca101.tiff", width = 10, height = 9, units = 'in', res = 200)
...
tiff("int_pca101.tiff", width = 10, height = 9, units = 'in', res = 200)
...
tiff("dup2_pca101.tiff", width = 10, height = 9, units = 'in', res = 200)
...
tiff("flank2_pca101.tiff", width = 10, height = 9, units = 'in', res = 200)
