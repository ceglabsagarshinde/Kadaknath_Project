pdf(file="genomewide101_pca1_pc2.pdf",width=10,height=10)
...
pdf(file="genomewide101_pca1_pc3.pdf",width=10,height=10)
#jpeg(file="kadaknath_ABCD_pca.jpeg",width=2500,height=2500)
C <- read.table(file="genolike_101.cov.cov")
m<-as.matrix(C)
e <- eigen(m, symm=TRUE)
...
pdf(file="genomewide101_pca2_pc3.pdf",width=10,height=10)
#jpeg(file="kadaknath_ABCD_pca.jpeg",width=2500,height=2500)
C <- read.table(file="genolike_101.cov.cov")
m<-as.matrix(C)
e <- eigen(m, symm=TRUE)
...
tiff("pca101.tiff", width = 10, height = 9, units = 'in', res = 200)
C <- read.table(file="genolike_101.cov.cov")
m<-as.matrix(C)
e <- eigen(m, symm=TRUE)
e$val <- e$val/sum(e$val)
...
tiff("pca101_1_3.tiff", width = 10, height = 9, units = 'in', res = 200)
C <- read.table(file="genolike_101.cov.cov")
m<-as.matrix(C)
e <- eigen(m, symm=TRUE)
e$val <- e$val/sum(e$val)
...
tiff("pca101_2_3.tiff", width = 10, height = 9, units = 'in', res = 200)
C <- read.table(file="genolike_101.cov.cov")
m<-as.matrix(C)
e <- eigen(m, symm=TRUE)
e$val <- e$val/sum(e$val)
